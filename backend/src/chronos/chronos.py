...
MODEL_PATH = "backend/src/chronos/models/chronos_v0.1.keras"
SCALER_PATH = "backend/src/chronos/preprocessing/minmax_scaler-7f.pkl"
...
class Chronos:
    ...
    def create_model_input(self):
        self.model_input = self.dataset.reshape(
            1, self.dataset.shape[0], self.dataset.shape[1]
        )  # TODO - examine here: reshape(1, self.lookback, self.dataset.shape[1])
