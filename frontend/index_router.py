...
pages = {
    ...
    "Analytics": [
        ...
        st.Page(
            "tab_pages/explorer.py",
            title="Blockchain Explorer",
            icon=":material/explore:",
        ),
    ],
    "News": [st.Page("tab_pages/reporting.py", title="Reporting", icon=":material/newspaper:")],
    "Crypto Wiki": [
        st.Page(
            "tab_pages/crypto_chatbot.py",
    ...
    "Stock Market": [
        st.Page(
            "tab_pages/stock_analysis.py",
            title="Stock Analysis",
            icon=":material/monitoring:",
        ),
        st.Page(
            "tab_pages/stock_portfolios.py",
            title="Stock Portfolios",
            icon=":material/inventory:",
        ),
    ],
    "Settings": [st.Page("tab_pages/settings.py", title="Settings", icon=":material/settings:")],
}
