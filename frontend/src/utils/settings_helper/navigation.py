...
from frontend.src.utils.settings_helper.html_elements import (
    status_card,
    status_card_style,
)
...
CRYPTO_APIS = {
    "binance": (
        "Binance API",
        "https://www.logo.wine/a/logo/Binance/Binance-Vertical2-Dark-Background-Logo.wine.svg",
    ),
    "binance_testnet": (
        "Binance Testnet API",
        "https://www.logo.wine/a/logo/Binance/Binance-Vertical2-Dark-Background-Logo.wine.svg",
...
LLM_APIS = {
    "openai": (
        "OpenAI API",
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSFJYCiV_aHxCRPoVcLeOChZWnb_qVxSQMm4Jr-C_x_0A&s",
    ),
    "gemini": (
        "Gemini API",
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQV1QWx0soc08N7wU8LjH95wZTkF_q13tg1KH4AOTs3xw&s",
    ),
    "hugging_face": (
        "Hugging Face API",
        "https://cdn.worldvectorlogo.com/logos/huggingface-2.svg",
    ),
    "anthropic": (
        "Anthropic",
...
LOCAL_LLMS = {
    "llama_cpp": (
        "Local LLAMA CPP",
        "https://repository-images.githubusercontent.com/612354784/c59e3320-a236-4182-941f-ea3f1a0f50e7",
    ),
    "tgi": (
        "Local TGI",
        "https://cdn-avatars.huggingface.co/v1/production/uploads/5f17f0a0925b9863e28ad517/NXI_YNqaf9ZvhVczj0kpz.png",
    ),
}
...
def show_homepage_status_cards() -> None:
    ...
    status_card_style()
    statuses = [
        session_state["backend_status"],
        session_state["binance_api_status"],
        session_state["binance_testnet_api_status"],
        session_state["kraken_api_status"],
        session_state["coinbase_api_status"],
        session_state["coinbase_sandbox_api_status"],
        session_state["mock_exchange_api_status"],
    ]
    i = 1
    html_txt = """<div class="section" id="apis">"""
    html_txt += status_card(
        "Backend Server",
