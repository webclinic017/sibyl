...
from frontend.src.utils.history_helper.funcs import (
    get_status_barplot,
...
if df is None:
    ...
    with th_tab:
        st.html(
            "<h4 style='text-align: left;margin-top:0.1em; margin-bottom:0.1em; padding:0;color:#5E5E5E'>Trading History Table</h4>"
        )
        trade_history_instructions()
        df["show_plot"] = False
