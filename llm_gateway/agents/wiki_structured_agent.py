...
class WikiStructuredAgent(AgentBase):
    ...
    def __init__(self, llm_model: LLMBase):
        ...
        self.llm: BaseChatModel = llm_model or init_chat_model(
            "anthropic:claude-3-5-sonnet-latest", api_key="your_key_here"
        )
    ...
    def _build_graph(self):
        ...
        def conversational_agent(state: State) -> dict[str, list[dict[str, str]]]:
            messages = [
                {
                    "role": "system",
                    "content": "You are a friendly chatbot for small talk.",
                },
